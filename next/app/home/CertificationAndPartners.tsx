...
const logos = [
  ...
  '/images/cert/iso9001.png',
  '/images/cert/tcvn.png',
  '/images/cert/astm.png',
  '/images/cert/bsen.png',
  '/images/partners/viettel.png',
  '/images/partners/vnsteel.png',
  '/images/partners/hoa-phat.png',
  '/images/partners/petrosetco.png',
  '/images/partners/bachkhoa.png',
];
